        ...
        <div className="page-wrapper">
              ...
              <div className="auto-container">
                <div className="inner-container clearfix">
                  ...
                  <div className="top-left pull-left">
                    <div className="text">
                      Welcome to Best IT Company Solution.
                    </div>
                  </div>
                  {/* Top Right */}
                  <div className="top-right pull-right">
                    ...
                    <ul className="info-list">
                      <li>
                        <span className="icon flaticon-maps-and-flags" /> 16122
                  ...
                  <div className="row clearfix">
                    ...
                    <div className="content-column col-lg-6 col-md-12 col-sm-12">
                      <div className="inner-column">
                        ...
                        <h1>
                          We’re Digital AIl <br /> Startup Support
                        </h1>
                        <div className="text">
                          We bet you don’t spend much time on the 2nd page{" "}
                          <br /> of Google - So why should your website,
                        </div>
                        <div className="clearfix">
                          ...
                          <div className="phone-box">
                            <span className="phone-icon fa fa-phone" />
                            <a className="phone" href="tel:+9999-999-999">
                              9999 999 999
                            </a>
                          </div>
                        </div>
          ...
          <section className="seo-section-two">
            <div
              ...
              style={{
                backgroundImage: "url(images/background/pattern-21.png)",
              }}
            />
            <div className="auto-container">
              <div className="row clearfix">
          ...
          {/* Clients Section Two */}
          <section className="clients-section-two margin-top">
            <div className="auto-container">
            ...
            <div className="auto-container">
              ...
              <div className="mixitup-gallery">
                ...
                <div className="btn-box text-center">
                  <a href="projects.html" className="theme-btn btn-style-eight">
          ...
          <section className="business-section">
            <div
              className="pattern-layer"
              style={{
                backgroundImage: "url(images/background/pattern-23.png)",
              }}
            />
            <div className="auto-container">
              {/* Sec Title */}
              <div className="sec-title light">
                ...
                <div className="text">
                  ...
                  our team of technical <br /> SEOs are true experts in their
                  field.
                </div>
              </div>
              <a href="about.html" className="theme-btn btn-style-eight">
                      ...
                      <div className="business-block">
                        <div className="inner-box">
                          ...
                          <div className="content">
                            ...
                            <div className="text">
                              To generate highly focused leads ready to
                              purchases our service
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="testimonial-block-two">
                  <div className="inner-box">
                    ...
                    <div className="text">
                      ...
                      business project that we will come back soom! Our strategy
                      includes consistently evolving, to ensure we’re producing
                        ...
                        <div className="acc-content">
                          <div className="content">
                            <div className="text">
                              ...
                              profits by building awareness, driving web
          ...
          <section className="news-section-two style-two">
            <div
              className="pattern-layer-two"
              style={{
                backgroundImage: "url(images/background/pattern-24.png)",
              }}
            />
            <div className="auto-container">
              {/* Sec Title */}
                  ...
                  >
                    ...
                    <div className="lower-content">
                      <ul className="post-meta">
                        <li>
                          <a href="news-detail.html">
                            <span className="icon fa fa-user" /> Adam Pando
                          </a>
                        </li>
                        <li>
                          <a href="news-detail.html">
                  ...
                  >
                    ...
                    <div className="lower-content">
                      <ul className="post-meta">
                        <li>
                          <a href="news-detail.html">
                            <span className="icon fa fa-user" /> Mark Roy
                          </a>
                        </li>
                        <li>
                          <a href="news-detail.html">
          ...
          <footer
            ...
            style={{
              backgroundImage: "url(images/background/map-pattern-2.png)",
            }}
          >
            <div className="auto-container">
              {/*Widgets Section*/}
                    ...
                    <div className="row clearfix">
                      ...
                      <div className="footer-column col-lg-6 col-md-6 col-sm-12">
                        <div className="footer-widget logo-widget">
                          ...
                          <div className="text">
                            Lorem ipsum dolor amet consectetur adip- ielit sed
                            eiusm tempor incididunt ut labore dolore magna
