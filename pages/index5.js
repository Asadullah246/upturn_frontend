        ...
        <div className="page-wrapper">
              ...
              <div className="row clearfix">
                ...
                <div className="content-column col-lg-6 col-md-12 col-sm-12">
                  ...
                  <div className="inner-column">
                    ...
                    <div className="text">
                      We bet you don’t spend much time on the 2nd page <br /> of
          ...
          <section className="news-section-two">
            <div
              className="pattern-layer"
              style={{
                backgroundImage: "url(images/background/pattern-11.jpg)",
              }}
            />
            <div className="auto-container">
              {/* Sec Title */}
                  ...
                  >
                    ...
                    <div className="lower-content">
                      <ul className="post-meta">
                        <li>
                          <a href="news-detail.html">
                            <span className="icon fa fa-user" /> George Joy
                          </a>
                        </li>
                        <li>
                          <a href="news-detail.html">
                      ...
                      <div className="text">
                        ...
                        people at the right time to increase organic traffic.
                      </div>
                      {/* Social Boxed */}
